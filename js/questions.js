...
const QUESTIONS = [
  ...
  /* ===================================================================
     HARD TIER — tougher items for every blueprint slot. The Full
     Simulation pulls these first so the test plays harder. (diff:'hard')
     =================================================================== */

  // ---- Verbal · Sentence Completion (double-blank, advanced) ----
  { id:'sch1', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'Though it claimed to be ____, the report’s selective use of data revealed a distinctly ____ purpose.',
    options:['impartial … partisan','thorough … neutral','biased … objective','balanced … fair'], answer:0,
    explanation:'A report that "claims to be X" but shows the opposite needs a contrast: it claimed to be impartial yet was partisan.' },
  { id:'sch2', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'The manager’s ____ apology did nothing to ____ the frustration of the customers she had ignored.',
    options:['heartfelt … inflame','perfunctory … assuage','sincere … worsen','genuine … ignore'], answer:1,
    explanation:'A half-hearted (perfunctory) apology would fail to assuage (soothe) frustration.' },
  { id:'sch3', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'Her writing is so ____ that even straightforward arguments become nearly ____ to follow.',
    options:['lucid … simple','convoluted … impossible','clear … effortless','concise … easy'], answer:1,
    explanation:'If simple arguments become hard to follow, the writing is convoluted, making them nearly impossible to follow.' },
  { id:'sch4', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'Far from being ____, the committee’s unanimous vote concealed a ____ undercurrent of dissent.',
    options:['divided … unified','genuine … simmering','harmonious … peaceful','honest … open'], answer:1,
    explanation:'"Concealed an undercurrent of dissent" means the unanimity wasn’t genuine — it hid a simmering disagreement.' },
  { id:'sch5', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'A truly ____ scientist remains ____ even when the evidence contradicts a cherished hypothesis.',
    options:['careless … emotional','rigorous … dispassionate','biased … stubborn','lazy … detached'], answer:1,
    explanation:'A rigorous scientist stays dispassionate (objective) regardless of personal preference.' },
  { id:'sch6', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'The novel’s ____ structure wove a dozen storylines into a surprisingly ____ whole.',
    options:['chaotic … messy','intricate … cohesive','simple … complex','dull … boring'], answer:1,
    explanation:'Many storylines forming a unified result = an intricate structure made cohesive.' },
  { id:'sch7', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'Rather than ____ the crisis, the hastily drafted policy only ____ it.',
    options:['resolving … exacerbated','solving … fixed','easing … calmed','ending … reduced'], answer:0,
    explanation:'"Rather than ___, only ___ it" needs opposites: rather than resolving, it exacerbated (worsened) the crisis.' },
  { id:'sch8', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'His ____ attention to detail bordered on the ____, delaying the launch for months.',
    options:['casual … reckless','obsessive … pathological','minimal … careless','relaxed … carefree'], answer:1,
    explanation:'Detail-focus that causes months of delay is obsessive — bordering on pathological.' },
  { id:'sch9', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'The senator’s answer was deliberately ____, crafted to ____ both sides without committing to either.',
    options:['decisive … alienate','equivocal … placate','blunt … offend','candid … anger'], answer:1,
    explanation:'An ambiguous (equivocal) answer is designed to placate (appease) everyone.' },
  { id:'sch10', category:'verbal', type:'Sentence Completion', diff:'hard',
    q:'Although the critic was usually ____, she was uncharacteristically ____ in her glowing review.',
    options:['generous … harsh','acerbic … effusive','kind … cruel','quiet … silent'], answer:1,
    explanation:'"Usually X, uncharacteristically Y" needs opposites: usually acerbic (sharp/biting), here effusive (gushing with praise).' },

  // ---- Verbal · Analogies (abstract relationships) ----
  { id:'anh1', category:'verbal', type:'Analogy', diff:'hard',
    q:'Ephemeral is to permanence as anonymous is to ____?',
    options:['identity','fame','secrecy','name'], answer:0,
    explanation:'Ephemeral things lack permanence; anonymous things lack identity (the quality each one is defined by lacking).' },
  { id:'anh2', category:'verbal', type:'Analogy', diff:'hard',
    q:'Maverick is to conformity as skeptic is to ____?',
    options:['doubt','belief','reason','science'], answer:1,
    explanation:'A maverick rejects conformity; a skeptic rejects (unquestioned) belief.' },
  { id:'anh3', category:'verbal', type:'Analogy', diff:'hard',
    q:'Drought is to water as blackout is to ____?',
    options:['electricity','light','darkness','heat'], answer:0,
    explanation:'A drought is a severe shortage of water; a blackout is a severe shortage of electricity.' },
  { id:'anh4', category:'verbal', type:'Analogy', diff:'hard',
    q:'Sycophant is to praise as critic is to ____?',
    options:['admiration','censure','flattery','silence'], answer:1,
    explanation:'A sycophant deals in (excessive) praise; a critic deals in censure (disapproval).' },
  { id:'anh5', category:'verbal', type:'Analogy', diff:'hard',
    q:'Sculptor is to marble as poet is to ____?',
    options:['words','paint','music','stone'], answer:0,
    explanation:'A sculptor shapes marble as raw material; a poet shapes words.' },
  { id:'anh6', category:'verbal', type:'Analogy', diff:'hard',
    q:'Vaccine is to immunity as education is to ____?',
    options:['ignorance','knowledge','teacher','school'], answer:1,
    explanation:'A vaccine produces immunity; education produces knowledge (the beneficial result each yields).' },

  // ---- Verbal · Antonyms (advanced vocabulary) ----
  { id:'anth1', category:'verbal', type:'Antonym', diff:'hard',
    q:'Which word is most nearly OPPOSITE to "PROFLIGATE"?',
    options:['thrifty','wasteful','extravagant','lavish'], answer:0,
    explanation:'Profligate means recklessly wasteful/extravagant; its opposite is thrifty.' },
  { id:'anth2', category:'verbal', type:'Antonym', diff:'hard',
    q:'Which word is most nearly OPPOSITE to "LACONIC"?',
    options:['terse','verbose','concise','blunt'], answer:1,
    explanation:'Laconic means using very few words; its opposite is verbose (wordy).' },
  { id:'anth3', category:'verbal', type:'Antonym', diff:'hard',
    q:'Which word is most nearly OPPOSITE to "MENDACIOUS"?',
    options:['deceitful','dishonest','sly','truthful'], answer:3,
    explanation:'Mendacious means lying/untruthful; its opposite is truthful.' },
  { id:'anth4', category:'verbal', type:'Antonym', diff:'hard',
    q:'Which word is most nearly OPPOSITE to "EPHEMERAL"?',
    options:['enduring','fleeting','brief','transient'], answer:0,
    explanation:'Ephemeral means short-lived; its opposite is enduring (long-lasting).' },
  { id:'anth5', category:'verbal', type:'Antonym', diff:'hard',
    q:'Which word is most nearly OPPOSITE to "OBDURATE"?',
    options:['stubborn','yielding','inflexible','harsh'], answer:1,
    explanation:'Obdurate means stubbornly unyielding; its opposite is yielding (compliant).' },
  { id:'anth6', category:'verbal', type:'Antonym', diff:'hard',
    q:'Which word is most nearly OPPOSITE to "UBIQUITOUS"?',
    options:['scarce','omnipresent','common','frequent'], answer:0,
    explanation:'Ubiquitous means present everywhere; its opposite is scarce (rarely found).' },

  // ---- Verbal · Attention to Detail (longer, confusable characters) ----
  (function(){ const t=adTable([
      ['INV-0O8821-XL','INV-008821-XL'], ['INV-449station','INV-449station'],
      ['INV-77l0-B2C','INV-7710-B2C'], ['INV-93021-KK','INV-93021-KK'],
      ['INV-50rn8-QA','INV-50m8-QA'] ]);
    return { id:'adh1', category:'verbal', type:'Attention to Detail', diff:'hard',
      q:'How many of the five items in the left-hand column are EXACTLY the same as the corresponding entry in the right-hand column?',
      svg:t.html, options:['1','2','3','4','5'], answer:t.identical-1,
      explanation:'Only rows 2 and 4 match. Row 1 (O vs 0), row 3 (l vs 1) and row 5 ("rn" vs "m") differ — so 2 are identical.' }; })(),
  (function(){ const t=adTable([
      ['Wollstonecraft & Pyne','Wollstonecraft & Pyne'], ['Achterberg Holdings','Achterburg Holdings'],
      ['Giannopoulos Trading','Giannopoulos Trading'], ['Szczepanski Bros.','Szczepanski Bros.'],
      ['Featherstonehaugh Ltd','Featherstonhaugh Ltd'] ]);
    return { id:'adh2', category:'verbal', type:'Attention to Detail', diff:'hard',
      q:'How many of the five items in the left-hand column are EXACTLY the same as the corresponding entry in the right-hand column?',
      svg:t.html, options:['1','2','3','4','5'], answer:t.identical-1,
      explanation:'Rows 1, 3 and 4 match. Row 2 ("Achterberg" vs "Achterburg") and row 5 (an extra "e" in "Featherstonehaugh") differ — so 3 are identical.' }; })(),
  (function(){ const t=adTable([
      ['44.0921.8837','44.0921.8837'], ['10.5567.2049','10.5567.2049'],
      ['72.3318.6610','72.3318.6160'], ['08.9904.1145','08.9940.1145'],
      ['61.2275.5093','61.2275.5093'] ]);
    return { id:'adh3', category:'verbal', type:'Attention to Detail', diff:'hard',
      q:'How many of the five items in the left-hand column are EXACTLY the same as the corresponding entry in the right-hand column?',
      svg:t.html, options:['1','2','3','4','5'], answer:t.identical-1,
      explanation:'Rows 1, 2 and 5 match. Row 3 ("6610" vs "6160") and row 4 ("9904" vs "9940") have transposed digits — so 3 are identical.' }; })(),
  (function(){ const t=adTable([
      ['1100 1011 0010','1100 1011 0010'], ['0111 0101 1101','0111 0101 1011'],
      ['1010 0011 1110','1010 0011 1110'], ['0001 1111 0100','0001 1111 0100'],
      ['1101 0010 1001','1101 0010 1001'] ]);
    return { id:'adh4', category:'verbal', type:'Attention to Detail', diff:'hard',
      q:'How many of the five items in the left-hand column are EXACTLY the same as the corresponding entry in the right-hand column?',
      svg:t.html, options:['1','2','3','4','5'], answer:t.identical-1,
      explanation:'Rows 1, 3, 4 and 5 match. Only row 2 differs ("1101" vs "1011" in the last block) — so 4 are identical.' }; })(),

  // ---- Math · Basic Math & Calculation (harder) ----
  { id:'bmh1', category:'math', type:'Basic Math', diff:'hard',
    q:'Calculate:  48 ÷ 8 + 3 × 5 − 2²',
    options:['17','33','21','25','11'], answer:0,
    explanation:'Exponents/×/÷ before +/−: 48÷8=6, 3×5=15, 2²=4 → 6 + 15 − 4 = 17.' },
  { id:'bmh2', category:'math', type:'Basic Math', diff:'hard',
    q:'Which of the following is the LARGEST?',
    options:['5/8','0.63','62%','3/5','0.609'], answer:1,
    explanation:'As decimals: 5/8 = 0.625, 0.63, 62% = 0.62, 3/5 = 0.60, 0.609. The largest is 0.63.' },
  { id:'bmh3', category:'math', type:'Basic Math', diff:'hard',
    q:'What is 0.2% of 3,500?',
    options:['7','70','0.7','700','35'], answer:0,
    explanation:'0.2% = 0.002. 0.002 × 3,500 = 7.' },
  { id:'bmh4', category:'math', type:'Basic Math', diff:'hard',
    q:'Compute:  (2/3) ÷ (4/9)',
    options:['3/2','8/27','2/3','9/8','6/7'], answer:0,
    explanation:'Dividing by a fraction = multiply by its reciprocal: (2/3) × (9/4) = 18/12 = 3/2.' },

  // ---- Math · Word Problems (multi-step) ----
  { id:'wph1', category:'math', type:'Word Problem', diff:'hard',
    q:'A 30-liter solution is 20% acid. How many liters of PURE acid must be added to make it 50% acid?',
    options:['12','15','18','20','9'], answer:2,
    explanation:'Acid now = 6 L. Need (6+x)/(30+x) = 0.5 → 6+x = 15+0.5x → 0.5x = 9 → x = 18 liters.' },
  { id:'wph2', category:'math', type:'Word Problem', diff:'hard',
    q:'Pipe A fills a tank in 4 hours and pipe B in 6 hours, while a drain empties it in 12 hours. With all three open, how long to fill the tank?',
    options:['2 hours','2.5 hours','3 hours','4 hours','6 hours'], answer:2,
    explanation:'Net rate = 1/4 + 1/6 − 1/12 = 3/12 + 2/12 − 1/12 = 4/12 = 1/3 tank/hour → 3 hours.' },
  { id:'wph3', category:'math', type:'Word Problem', diff:'hard',
    q:'After a 10% raise and then a 10% pay cut, an employee earns $49,500. What was the original salary?',
    options:['$49,000','$50,000','$50,500','$45,000','$55,000'], answer:1,
    explanation:'1.10 × 0.90 = 0.99 of the original. Original = 49,500 ÷ 0.99 = $50,000.' },
  { id:'wph4', category:'math', type:'Word Problem', diff:'hard',
    q:'Two cars start 300 miles apart and drive toward each other at 50 mph and 70 mph. How long until they meet?',
    options:['2 hours','2.5 hours','3 hours','3.5 hours','4 hours'], answer:1,
    explanation:'Closing speed = 50 + 70 = 120 mph. Time = 300 ÷ 120 = 2.5 hours.' },
  { id:'wph5', category:'math', type:'Word Problem', diff:'hard',
    q:'A student’s average over 5 tests is 82. After a 6th test the average rises to 84. What did the student score on the 6th test?',
    options:['86','90','92','94','96'], answer:3,
    explanation:'New total = 6 × 84 = 504; old total = 5 × 82 = 410. Sixth score = 504 − 410 = 94.' },
  { id:'wph6', category:'math', type:'Word Problem', diff:'hard',
    q:'$1,800 is divided among A, B, and C in the ratio 2 : 3 : 4. How much does C receive?',
    options:['$400','$600','$800','$900','$720'], answer:2,
    explanation:'Total parts = 9, so one part = 1,800 ÷ 9 = 200. C gets 4 parts = $800.' },
  { id:'wph7', category:'math', type:'Word Problem', diff:'hard',
    q:'$2,000 is invested at 5% interest compounded annually. What is it worth after 3 years (to the nearest dollar)?',
    options:['$2,300','$2,315','$2,310','$2,205','$2,331'], answer:1,
    explanation:'2,000 × 1.05³ = 2,000 × 1.157625 = $2,315.25 ≈ $2,315.' },
  { id:'wph8', category:'math', type:'Word Problem', diff:'hard',
    q:'A father is currently 4 times his son’s age. In 6 years, he will be only 2.5 times his son’s age. How old is the son now?',
    options:['4','5','6','8','10'], answer:2,
    explanation:'Let son = s. 4s + 6 = 2.5(s + 6) → 4s + 6 = 2.5s + 15 → 1.5s = 9 → s = 6.' },
  { id:'wph9', category:'math', type:'Word Problem', diff:'hard',
    q:'A driver travels 2 hours at 30 mph and then 3 hours at 50 mph. What is the average speed for the whole trip?',
    options:['40 mph','42 mph','44 mph','45 mph','48 mph'], answer:1,
    explanation:'Distance = 60 + 150 = 210 miles over 5 hours → 210 ÷ 5 = 42 mph.' },
  { id:'wph10', category:'math', type:'Word Problem', diff:'hard',
    q:'A $200 item is marked up 25%, then discounted 20%, then discounted a further 10%. What is the final price?',
    options:['$170','$176','$180','$190','$200'], answer:2,
    explanation:'200 × 1.25 = 250; × 0.80 = 200; × 0.90 = $180.' },
  { id:'wph11', category:'math', type:'Word Problem', diff:'hard',
    q:'Two fair dice are rolled. What is the probability that the sum is exactly 8?',
    options:['1/6','5/36','1/9','1/12','7/36'], answer:1,
    explanation:'Sums of 8: (2,6)(3,5)(4,4)(5,3)(6,2) = 5 ways out of 36 → 5/36.' },
  { id:'wph12', category:'math', type:'Word Problem', diff:'hard',
    q:'How many distinct arrangements can be made from the letters of the word "LEVEL"?',
    options:['120','60','30','24','20'], answer:2,
    explanation:'5 letters with L twice and E twice: 5! ÷ (2! × 2!) = 120 ÷ 4 = 30.' },
  { id:'wph13', category:'math', type:'Word Problem', diff:'hard',
    q:'What principal earns $360 in simple interest at 6% per year over 2 years?',
    options:['$2,400','$3,000','$3,600','$6,000','$1,800'], answer:1,
    explanation:'I = P·r·t → 360 = P × 0.06 × 2 = 0.12P → P = 360 ÷ 0.12 = $3,000.' },
  { id:'wph14', category:'math', type:'Word Problem', diff:'hard',
    q:'A worker can finish a job in 12 days and another in 18 days. Working together, how many days to finish?',
    options:['6.0','7.2','7.5','8.0','9.0'], answer:1,
    explanation:'Combined rate = 1/12 + 1/18 = 3/36 + 2/36 = 5/36 per day → 36/5 = 7.2 days.' },

  // ---- Math · Number Series (second-order & interleaved) ----
  { id:'nsh1', category:'math', type:'Number Series', diff:'hard',
    q:'What number comes next?  2, 5, 10, 17, 26, ____',
    options:['35','37','38','36','40'], answer:1,
    explanation:'Differences are 3, 5, 7, 9 (odd numbers), so the next gap is 11: 26 + 11 = 37.' },
  { id:'nsh2', category:'math', type:'Number Series', diff:'hard',
    q:'What number comes next?  1, 2, 4, 7, 11, 16, ____',
    options:['20','21','22','23','24'], answer:2,
    explanation:'Differences grow 1, 2, 3, 4, 5, so the next gap is 6: 16 + 6 = 22.' },
  { id:'nsh3', category:'math', type:'Number Series', diff:'hard',
    q:'What number comes next?  3, 9, 6, 12, 9, 15, ____',
    options:['11','12','18','21','13'], answer:1,
    explanation:'The pattern alternates +6 then −3: 3,+6→9,−3→6,+6→12,−3→9,+6→15,−3→12.' },
  { id:'nsh4', category:'math', type:'Number Series', diff:'hard',
    q:'What number comes next?  2, 6, 12, 20, 30, ____',
    options:['40','42','44','38','36'], answer:1,
    explanation:'Differences are 4, 6, 8, 10, so the next gap is 12: 30 + 12 = 42 (these are n²+n).' },
  { id:'nsh5', category:'math', type:'Number Series', diff:'hard',
    q:'What number comes next?  1, 3, 7, 15, 31, ____',
    options:['47','62','63','64','61'], answer:2,
    explanation:'Each term is doubled and +1: 31 × 2 + 1 = 63.' },
  { id:'nsh6', category:'math', type:'Number Series', diff:'hard',
    q:'What number comes next?  4, 9, 25, 49, ____',
    options:['64','81','100','121','144'], answer:3,
    explanation:'These are the squares of the prime numbers 2, 3, 5, 7. The next prime is 11, and 11² = 121.' },

  // ---- Math · Tables & Graphs (multi-step) ----
  { id:'tgh1', category:'math', type:'Table & Graph', diff:'hard',
    q:'The bar chart shows daily sales. What is the percent increase from the lowest day to the highest day?',
    svg: barChart(['Mon','Tue','Wed','Thu','Fri'],[20,35,30,50,25]),
    options:['100%','120%','150%','60%','30%'], answer:2,
    explanation:'Lowest = 20 (Mon), highest = 50 (Thu). Increase = (50 − 20) ÷ 20 = 30/20 = 150%.' },
  { id:'tgh2', category:'math', type:'Table & Graph', diff:'hard',
    q:'The table shows monthly sales by store. Which month had the highest TOTAL across all four stores?',
    svg: dataTable(['Store','Jan','Feb','Mar'],[['A','120','150','130'],['B','140','110','160'],['C','90','170','120'],['D','160','100','150']]),
    options:['January','February','March','Jan and Feb tie','All equal'], answer:2,
    explanation:'Totals: Jan = 510, Feb = 530, Mar = 560. March is the highest.' },
  { id:'tgh3', category:'math', type:'Table & Graph', diff:'hard',
    q:'The bar chart shows tickets sold per show. What percent of all tickets were sold for Show B?',
    svg: barChart(['A','B','C','D'],[25,35,15,25]),
    options:['25%','30%','35%','40%','20%'], answer:2,
    explanation:'Total = 25 + 35 + 15 + 25 = 100. Show B = 35, so 35/100 = 35%.' },
  { id:'tgh4', category:'math', type:'Table & Graph', diff:'hard',
    q:'The table shows a store’s quarterly revenue. What was the percent change in revenue from Q1 to Q4?',
    svg: dataTable(['Quarter','Revenue ($k)'],[['Q1','80'],['Q2','95'],['Q3','110'],['Q4','100']]),
    options:['+20%','+25%','+15%','+30%','+10%'], answer:1,
    explanation:'Change = (100 − 80) ÷ 80 = 20/80 = 0.25 = +25%.' },

  // ---- Math/Logic · Syllogism (subtle quantifiers) ----
  { id:'syh1', category:'math', type:'Syllogism', diff:'hard',
    q:'If the first two statements are true, is the final statement true? — No reptiles are warm-blooded. All snakes are reptiles. Therefore, no snakes are warm-blooded.',
    options:['True','False','Uncertain'], answer:0,
    explanation:'Snakes ⊆ reptiles, and no reptile is warm-blooded, so no snake is warm-blooded. Valid: True.' },
  { id:'syh2', category:'math', type:'Syllogism', diff:'hard',
    q:'If the first two statements are true, is the final statement true? — Some artists are engineers. All engineers are logical. Therefore, some artists are logical.',
    options:['True','False','Uncertain'], answer:0,
    explanation:'The artists who are engineers must be logical (all engineers are), so some artists are logical. Valid: True.' },
  { id:'syh3', category:'math', type:'Syllogism', diff:'hard',
    q:'If the first two statements are true, is the final statement true? — All poets are dreamers. Some dreamers are wealthy. Therefore, some poets are wealthy.',
    options:['True','False','Uncertain'], answer:2,
    explanation:'The wealthy dreamers need not be among the poets, so this does not follow — Uncertain.' },
  { id:'syh4', category:'math', type:'Syllogism', diff:'hard',
    q:'If the first two statements are true, is the final statement true? — Most of the team attended the meeting. Dana is on the team. Therefore, Dana attended the meeting.',
    options:['True','False','Uncertain'], answer:2,
    explanation:'"Most" is not "all," so Dana may be among the minority who did not attend — Uncertain.' },
  { id:'syh5', category:'math', type:'Syllogism', diff:'hard',
    q:'If the first two statements are true, is the final statement true? — All metals conduct electricity. Mercury conducts electricity. Therefore, mercury is a metal.',
    options:['True','False','Uncertain'], answer:2,
    explanation:'Conducting electricity doesn’t make something a metal (it affirms the consequent) — Uncertain.' },

  // ---- Math/Logic · Seating Arrangement (more constraints) ----
  { id:'seh1', category:'math', type:'Seating Arrangement', diff:'hard',
    q:'Six people sit in seats 1–6 (left to right). Xena is in seat 1. Vic is in seat 4. Tom sits somewhere left of Uma. Wes sits immediately to the right of Uma. Yara is not in seat 6. Who is in seat 6?',
    options:['Wes','Tom','Uma','Yara','Vic'], answer:0,
    explanation:'Seats 2,3,5,6 remain for Tom, Uma, Wes, Yara. Wes = Uma+1 forces Uma=5, Wes=6 (Uma=2 would put Tom before seat 1). Seat 6 is Wes.' },
  { id:'seh2', category:'math', type:'Seating Arrangement', diff:'hard',
    q:'Five books sit on a shelf in positions 1–5. Mystery is in position 2. Novel is immediately left of Poetry. Recipe is somewhere right of Poetry. Science is at one of the two ends. Which book is in position 1?',
    options:['Science','Novel','Poetry','Recipe','Mystery'], answer:0,
    explanation:'With Mystery=2, the Novel-Poetry pair must occupy 3-4 and Recipe=5, leaving position 1 (an end) for Science.' },
  { id:'seh3', category:'math', type:'Seating Arrangement', diff:'hard',
    q:'Five friends sit in seats 1–5. C is in seat 1. B sits somewhere to the right of A. D sits immediately to the left of E. If A is in seat 4, which must be true?',
    options:['E is in seat 3','B is in seat 2','D is in seat 5','A is in seat 2','E is in seat 1'], answer:0,
    explanation:'C=1, A=4 → B must be right of A, so B=5. Seats 2,3 take D,E with D immediately left of E → D=2, E=3. So E is in seat 3.' },

  // ---- Spatial · Next in Series (multiple features change) ----
  { id:'nish1', category:'spatial', type:'Next in Series', diff:'hard',
    q:'The arrow rotates by the same amount each step. Which comes next?',
    svg: vseq([ vtile(arrow(0)), vtile(arrow(135)), vtile(arrow(270)), qmark() ]),
    options:['Pointing down-right','Pointing right','Pointing down','Pointing left','Pointing up'],
    svgOptions:[ otile(arrow(45)), otile(arrow(0)), otile(arrow(90)), otile(arrow(180)), otile(arrow(270)) ],
    answer:0,
    explanation:'Each step rotates 135° clockwise (0° → 135° → 270°). The next is 270° + 135° = 405° = 45°, pointing down-right.' },
  { id:'nish2', category:'spatial', type:'Next in Series', diff:'hard',
    q:'How many dots should the next figure have?',
    svg: vseq([ vtile(dots(1)), vtile(dots(2)), vtile(dots(4)), qmark() ]),
    options:['8 dots','6 dots','7 dots','5 dots','9 dots'],
    svgOptions:[ otile(dots(8)), otile(dots(6)), otile(dots(7)), otile(dots(5)), otile(dots(9)) ],
    answer:0,
    explanation:'The dot count doubles each step (1, 2, 4), so the next figure has 8 dots.' },
  { id:'nish3', category:'spatial', type:'Next in Series', diff:'hard',
    q:'Two things change each step. Which figure completes the series?',
    svg: vseq([ vtile(poly(6,{fill:'none'})), vtile(poly(5,{fill:'solid'})), vtile(poly(4,{fill:'none'})), qmark() ]),
    options:['Filled triangle','Empty triangle','Filled square','Light triangle','Filled circle'],
    svgOptions:[ otile(poly(3,{fill:'solid'})), otile(poly(3,{fill:'none'})), otile(poly(4,{fill:'solid'})), otile(poly(3,{fill:'light'})), otile(circ({fill:'solid'})) ],
    answer:0,
    explanation:'Sides decrease by one (6, 5, 4 → 3) and the fill alternates empty/solid (empty, solid, empty → solid). The answer is a filled triangle.' },

  // ---- Spatial · Odd One Out (subtle) ----
  { id:'ooh1', category:'spatial', type:'Odd One Out', diff:'hard',
    q:'Which of the following does NOT belong?',
    svg: vseq([ vtile(poly(8)), vtile(poly(8)), vtile(poly(7)), vtile(poly(8)), vtile(poly(8)) ]),
    options:['1st figure','2nd figure','3rd figure','4th figure','5th figure'],
    answer:2,
    explanation:'Four figures are octagons (8 sides); the 3rd has only 7 sides (a heptagon), so it is the odd one out.' },
  { id:'ooh2', category:'spatial', type:'Odd One Out', diff:'hard',
    q:'Which of the following does NOT belong, based on the number of dots?',
    svg: vseq([ vtile(dots(2)), vtile(dots(3)), vtile(dots(5)), vtile(dots(4)), vtile(dots(7)) ]),
    options:['1st figure','2nd figure','3rd figure','4th figure','5th figure'],
    answer:3,
    explanation:'The dot counts are 2, 3, 5, 4, 7 — all prime except the 4th figure (4 is composite), so it is the odd one out.' },
  { id:'ooh3', category:'spatial', type:'Odd One Out', diff:'hard',
    q:'Which of the following does NOT belong?',
    svg: vseq([ vtile(cellSquares(4)), vtile(cellSquares(4)), vtile(cellSquares(3)), vtile(cellSquares(4)), vtile(cellSquares(4)) ]),
    options:['1st figure','2nd figure','3rd figure','4th figure','5th figure'],
    answer:2,
    explanation:'Each grid has 4 shaded squares except the 3rd, which has only 3 — the odd one out.' },
  { id:'ooh4', category:'spatial', type:'Odd One Out', diff:'hard',
    q:'Which of the following does NOT belong?',
    svg: vseq([ vtile(poly(5,{rot:0})), vtile(poly(5,{rot:0})), vtile(poly(5,{rot:36})), vtile(poly(5,{rot:0})), vtile(poly(5,{rot:0})) ]),
    options:['1st figure','2nd figure','3rd figure','4th figure','5th figure'],
    answer:2,
    explanation:'Four pentagons point upward (a vertex at the top); the 3rd is rotated so it points downward — the odd one out.' },
  { id:'ooh5', category:'spatial', type:'Odd One Out', diff:'hard',
    q:'Which of the following does NOT belong?',
    svg: vseq([ vtile(nested([4,0])), vtile(nested([4,0])), vtile(nested([4,4])), vtile(nested([4,0])), vtile(nested([4,0])) ]),
    options:['1st figure','2nd figure','3rd figure','4th figure','5th figure'],
    answer:2,
    explanation:'Each figure is a square containing a circle, except the 3rd, which contains a smaller square — the odd one out.' },

  // ---- Spatial · Matrices (harder / closer distractors) ----
  { id:'mxh1', category:'spatial', type:'Matrix', diff:'hard',
    q:'Which option should replace the question mark to complete the pattern?',
    svg: matrix3([ cellSquares(1),cellSquares(2),cellSquares(3),
                   cellSquares(3),cellSquares(4),cellSquares(5),
                   cellSquares(5),cellSquares(6),mqmark() ]),
    options:['7 squares filled','6 squares filled','8 squares filled','5 squares filled','4 squares filled'],
    svgOptions:[ otile(cellSquares(7)), otile(cellSquares(6)), otile(cellSquares(8)), otile(cellSquares(5)), otile(cellSquares(4)) ],
    answer:0,
    explanation:'Across each row the count rises by 1; down each column it rises by 2. The bottom row is 5, 6, so the missing cell has 7 filled squares.' },
  { id:'mxh2', category:'spatial', type:'Matrix', diff:'hard',
    q:'Which option should replace the question mark to complete the pattern?',
    svg: matrix3([ poly(4,{fill:'none'}), poly(5,{fill:'none'}), poly(6,{fill:'none'}),
                   poly(4,{fill:'light'}),poly(5,{fill:'light'}),poly(6,{fill:'light'}),
                   poly(4,{fill:'solid'}),poly(5,{fill:'solid'}), mqmark() ]),
    options:['Solid hexagon','Light hexagon','Solid pentagon','Empty hexagon','Solid heptagon'],
    svgOptions:[ otile(poly(6,{fill:'solid'})), otile(poly(6,{fill:'light'})), otile(poly(5,{fill:'solid'})), otile(poly(6,{fill:'none'})), otile(poly(7,{fill:'solid'})) ],
    answer:0,
    explanation:'Across each row the shape gains a side (square → pentagon → hexagon); down each column the shading darkens (empty → light → solid). The missing cell is a solid hexagon.' },
];

/* Mark a selection of existing tougher questions as hard too, so each blueprint
   slot has a deep enough "hard" pool to fill a full simulation. */
['mh1','mh2','mh3','mh5','mh6','mh7','mh9','mh10','vh1','vh2','vh3','vh5','vh6','vh7','vh8',
 'lg1','lg2','lg6','sy2','sy6','mx2','mx3','mxs1','mxs2','mxs3','sv2','sv3','sv4',
 'oo2','oo5','oo6','ns1','m16','m35'].forEach(function(id){
  var q=QUESTIONS.find(function(x){return x.id===id;}); if(q) q.diff='hard';
});
