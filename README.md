...
[`water/`](water/) — **East Valley Soft Water**, a separate static marketing
site for a water softener and filtration installation business serving the East
Valley of Phoenix. Generated by `node scripts/water-site/build.mjs`; operating
docs, pricing model and SEO checklist in [water/README.md](water/README.md).
Lives at `/hydration-tracker/water/` and is independent of the CCAT app.
